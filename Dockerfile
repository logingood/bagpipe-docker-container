...
RUN apt-get update
RUN apt-get install -qy --no-install-recommends python python-daemon python-setuptools python-pip unzip wget git gcc python-dev fping bridge-utilsopenvswitch-common
